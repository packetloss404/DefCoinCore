...
First, in terms of structure, there is no particular concept of "Defcoin Core
...
fork of Defcoin Core copies the merge. Instead, make any username mentions in a
...
extensive discussion and have a generally widely perceived technical consensus of being
...
spread out over GitHub and other communication channels).
...
discussed extensively and have a generally widely perceived technical consensus of being
a worthwhile change based on the judgement of the maintainers.
...
The project lead is the release manager for each Defcoin Core release.

Copyright
---------

Defcoin Core is based on Litecoin Core and Bitcoin Core.
