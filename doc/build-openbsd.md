...
(see issue [#6658](https://github.com/bitcoin/bitcoin/issues/6658)) — note that this
is an upstream Bitcoin Core issue; the underlying OpenBSD `ulimit` behaviour is
the same here.
